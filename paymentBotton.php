...
function payment($param1)
{
    ...
    if ($data1['code'] == 0) {
        ...
        $replyMarkupp = array(
            'keyboard' => array(
                array("Share the application", "End our chat")
            ),
        ...
        $reponseMarchand =  "echec de la transaction  \n \n reférence de la transaction <b>" . $ref . "</b> \n Numero de téléphone:" .$userTG['phone'];
        ...
        $reply = urlencode($reponseMarchand);
