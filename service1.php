                        ...
                        switch ($code) {
                            case 1:
                                if ($message > 655000000 && $message <= 699999999) {
                                    ...
                                    $base->exec($req1);
                                    $reply = urlencode(" Please enter send me the amount or choose  \n \n 99. To return \n 10. To end process");
                                } else {
                                ...
                                case 1:
                                    switch ($userTG['methode']) {
                                        ...
                                        case 2:
                                            ...
                                            break;
                                        case 3:
                                            $validTest = urlencode("Confirm the transaction in your Express Union account");
                                            break;
                                    }
                                    file_get_contents("https://api.telegram.org/bot$token/sendmessage?chat_id=$chatId&text=$validTest");
                                    require_once('payment.php');
                                    $resp = payment($userTG['chatId']);
